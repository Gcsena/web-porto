  ...
  return (
    <FirstVisitWrapper>
      <div className={styles.container}>
        ...
        {/* Top Japanese Text */}
        <div className="absolute top-12 left-4 sm:top-16 sm:left-6 md:top-20 md:left-8 lg:left-10 
        ...
        <div className="absolute top-1/2 -translate-y-1/2 right-3 sm:right-4 md:right-6 lg:right-8 text-right">
          <div className="flex items-center justify-end gap-1 mb-1">
            <h1 className="text-[0.75rem] sm:text-[0.875rem] md:text-base lg:text-lg xl:text-xl
                           font-medium tracking-[0.1em] sm:tracking-[0.15em] text-fuchsia-500
                           hover:text-fuchsia-400 transition-colors">
              GARUDA
            </h1>
            <span className="text-[0.75rem] sm:text-[0.875rem] md:text-base lg:text-lg xl:text-xl
          ...
          <h1 className="text-[0.75rem] sm:text-[0.875rem] md:text-base lg:text-lg xl:text-xl
                         font-medium tracking-[0.1em] sm:tracking-[0.15em] text-fuchsia-500
                         hover:text-fuchsia-400 transition-colors mb-1">
            CASASENA
          </h1>
        ...
        {/* Side Japanese Text */}
        <div className={`${styles.sideJapanese} absolute top-1/2 -translate-y-1/2 
